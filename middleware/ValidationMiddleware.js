...
export const validateJobInput = withValidationErrors([
  ...
  body('jobStatus').optional().isIn(['pending', 'interview', 'declined']).withMessage('Invalid job status'),
  body('jobType').optional().isIn(['full-time', 'part-time', 'internship']).withMessage('Invalid job type'),
  body('jobLocation').optional().notEmpty().withMessage('Job location cannot be empty'),
]);
